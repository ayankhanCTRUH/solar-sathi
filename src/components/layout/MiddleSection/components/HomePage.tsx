...
const HomePage = ({ handleClick }: { handleClick: () => void }) => {
  return (
    <div className="font-dm-sans relative flex h-full flex-col items-center justify-center gap-12 text-white before:absolute before:top-50 before:z-[-1] before:w-full before:h-full before:backdrop-blur-sm">
